...
public class Game {
    ...
    public void processStatus(final GameStatus newStage) {
        ...
        switch (newStage) {
            ...
            case PLAYING:
                ...
                this.currentRound = new Round(this, this.getCurrentRound() == null ? 1 : this.getCurrentRound().getNumber() + 1, this.getDeck().getRandomBlackCard(), this.getPlayers().get(index));
                this.deal();
                this.sendMessage(" ");
    ...
    public void stop() {
        ...
        if (this.gameStatus != GameStatus.IDLE) {
            ...
            this.sendMessage(Colors.BOLD + "The game has ended. Start time: " + p.format(new Date(System.currentTimeMillis() - this.startTime)));
